import { Box, Button, Container, InputAdornment, Paper, TextField, Typography, Chip } from "@mui/material";
...
const HeroSection = () => (
  <Box sx={{ bgcolor: colors.white, borderBottom: `1px solid ${colors.secondaryGrey3}` }}>
    <Container maxWidth={false} className={styles.container} sx={{ px: { xs: 2, md: 3 } }}>
      <Typography variant="h4" className={styles.title} sx={{ color: colors.primary, mb: 3, fontWeight: 800 }}>
      ...
      <Box className={styles.trendingContainer}>
        <Typography variant="body2" className={styles.trendingLabel} sx={{ color: colors.primaryGrey1, fontWeight: 600 }}>
          Popular Searches:
        </Typography>
